...
# 2) Complete the solution so that it returns true if the first argument(string) 
...
# 4) Deoxyribonucleic acid (DNA) is a chemical found in the nucleus of cells and carries the "instructions" 
...
# 5) Complete the function that accepts a string parameter, 
